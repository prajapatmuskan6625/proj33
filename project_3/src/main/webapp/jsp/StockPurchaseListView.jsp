...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.STOCKPURCHASE_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("orderType", String.valueOf(dto.getQuantity()), map)%></div>



     <div class="col-sm-2">
					<input type="text" class="form-control" name="purchasePriceError"
						placeholder=" Enter PurchasePrice"
						oninput="handleIntegerInput(this, 'purchasePriceError', 10)"
						onblur="validateIntegerInput(this, 'purchasePriceError', 10)"
						value="<%=ServletUtility.getParameter("purchasePriceError", request)%>">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="20%" class="text">OrderType</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="StockPurchaseCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
