	...
	<div class="header">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			 ...
			 <li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"><i
							class="fas fa-calculator"></i>Inventory Trade</a> <a
			...
			<%--  <li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: black;">Trade</font>
...
<a class="dropdown-item" href="<%=ORSView.STOCKPURCHASE_CTL%>"> <i
							class="far fa-file"></i>Add StockPurchase
						</a> <a class="dropdown-item" href="<%=ORSView.STOCKPURCHASE_LIST_CTL%>">
							<i class="fas fa-paste"></i>StockPurchase List
...
<%-- <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PORTFOLIOMANAGEMENT_CTL%>"> <i
							class="fas fa-user-circle"></i>Add PortFolioManagement 
						</a> <a class="dropdown-item" href="<%=ORSView.PORTFOLIOMANAGEMENT_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>PortFolioManagement List</a>
					</div></li>
